...
class A6Servo : public Servo {
    ...
    private:
        ...
        Modbus::Error write_hold_register(uint16_t addr, T value) {
            ...
            LogOutput::printf("A6Servo: write_hold_register(0x%04X) failed after 3 retries!", addr);
        ...
        Modbus::Error read_hold_register(uint16_t addr, T& value) {
            ...
            LogOutput::printf("A6Servo: read_hold_register(0x%04X) failed after 3 retries!", addr);
            return response.getError();
        }
