...
class ABSOscillation : public SimElement {
    ...
    public:
        ...
        void forceOffset(DAP_calculationVariables_st* calcVars_st, uint8_t absPattern, uint8_t absForceOrTarvelBit, float* absForceOffset,
                         float* absPosOffset) {
                ...
                switch (absPattern) {
                    ...
                    case 1:
                        ...
                        if (calcVars_st->absFrequency > 0) {
                            absForceOffset_local =
                                absAmp_fl32 * fmod(absTimeSeconds, 1.0 / (float)calcVars_st->absFrequency) * (float)calcVars_st->absFrequency;
