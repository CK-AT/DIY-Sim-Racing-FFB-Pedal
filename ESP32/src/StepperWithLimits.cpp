...
void StepperWithLimits::findMinMaxSensorless(isv57communication * isv57, DAP_base_config_st& mech_config_st)
{
  ...
  float spindlePitch = max( mech_config_st.data.spindlePitch_mmPerRev_u8, (uint8_t)1 );
  float maxRevToReachEndPos = (float)mech_config_st.data.lengthPedal_travel / spindlePitch;
