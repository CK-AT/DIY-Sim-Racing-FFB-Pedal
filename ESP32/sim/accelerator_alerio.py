...
async def load_config(serial, store=False):
    ...
    msg.function_config.base.output_min = -14.0
    msg.function_config.base.output_max = 3.0
    
    msg.function_config.automotive_pedal.force_curve_config.pos_min = -14
    msg.function_config.automotive_pedal.force_curve_config.pos_max = 3
    ...
    msg.function_config.automotive_pedal.pos_end = 3
