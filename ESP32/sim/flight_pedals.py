...
async def load_config(serial, store=False):
    ...
    msg.function_config.base.function_id = ffb_protocol.FUNCTION_FLIGHT_PEDALS
    msg.function_config.base.linked_axes.append(ffb_protocol.AXIS_3)
    msg.function_config.base.linked_axes.append(ffb_protocol.AXIS_2 + ffb_protocol.AXIS_SUBTRACTIVE)
    ...
    msg.function_config.flight_pedal.pos_near_lim = 30
    msg.function_config.flight_pedal.pos_far_lim = 70
    msg.function_config.flight_pedal.damping = 0.15
    msg.function_config.flight_pedal.centering_spring_const = 1.5
