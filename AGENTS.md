...
- When vehicle graph paths/templates change, auto-migrate graph parameter overrides to the new graph and log/report dropped or renamed parameters; add GraphTest coverage for the migration mapping.
